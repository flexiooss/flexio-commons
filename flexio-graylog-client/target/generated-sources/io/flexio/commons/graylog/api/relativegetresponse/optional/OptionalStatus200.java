package io.flexio.commons.graylog.api.relativegetresponse.optional;
...
public class OptionalStatus200 {
  ...
  private OptionalSearchResponse payload = this.payload;
  ...
  public synchronized OptionalSearchResponse payload() {
    if(this.payload == null) {
      this.payload = OptionalSearchResponse.of(this.optional.isPresent() ? this.optional.get().payload() : null);
    }
    return this.payload;
  }

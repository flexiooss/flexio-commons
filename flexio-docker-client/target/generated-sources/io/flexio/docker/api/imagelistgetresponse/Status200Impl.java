...
class Status200Impl implements Status200 {
  private final ValueList<Image> payload;

  Status200Impl(ValueList<Image> payload) {
    this.payload = payload;
  }

  public ValueList<Image> payload() {
    return this.payload;
  }

  public Status200 withPayload(ValueList<Image> value) {

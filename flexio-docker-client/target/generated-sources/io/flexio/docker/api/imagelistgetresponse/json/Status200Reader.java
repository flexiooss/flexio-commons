...
import io.flexio.docker.api.imagelistgetresponse.Status200.Builder;
...
public class Status200Reader {
  ...
  public Status200[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.imagelistgetresponse.Status200 array, current token was %s", parser.currentToken()));
  }

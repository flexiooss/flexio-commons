...
import io.flexio.docker.api.containerdeleteresponse.Status400.Builder;
...
public class Status400Reader {
  ...
  public Status400[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.containerdeleteresponse.Status400 array, current token was %s", parser.currentToken()));
  }

package io.flexio.docker.api.versiongetresponse.optional;
...
public class OptionalStatus200 {
  ...
  private OptionalVersion payload = this.payload;
  ...
  public synchronized OptionalVersion payload() {
    if(this.payload == null) {
      this.payload = OptionalVersion.of(this.optional.isPresent() ? this.optional.get().payload() : null);
    }
    return this.payload;
  }

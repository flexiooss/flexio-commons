...
public class InspectImageGetResponseWriter {
  public void write(JsonGenerator generator, InspectImageGetResponse value) throws IOException {
  ...
  public void writeArray(JsonGenerator generator, InspectImageGetResponse[] values) throws IOException {
    if(values == null) {
      generator.writeNull();
    } else {
      generator.writeStartArray();
      for(InspectImageGetResponse value : values) {

...
public class StopPostResponseWriter {
  public void write(JsonGenerator generator, StopPostResponse value) throws IOException {
  ...
  public void writeArray(JsonGenerator generator, StopPostResponse[] values) throws IOException {
    if(values == null) {
      generator.writeNull();
    } else {
      generator.writeStartArray();
      for(StopPostResponse value : values) {

...
import io.flexio.docker.api.killpostresponse.Status204.Builder;
...
public class Status204Reader {
  ...
  public Status204[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.killpostresponse.Status204 array, current token was %s", parser.currentToken()));
  }

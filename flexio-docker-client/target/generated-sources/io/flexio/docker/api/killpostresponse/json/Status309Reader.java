...
import io.flexio.docker.api.killpostresponse.Status309.Builder;
...
public class Status309Reader {
  ...
  public Status309[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.killpostresponse.Status309 array, current token was %s", parser.currentToken()));
  }

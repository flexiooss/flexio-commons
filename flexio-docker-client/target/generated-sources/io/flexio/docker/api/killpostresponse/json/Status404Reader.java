...
import io.flexio.docker.api.killpostresponse.Status404.Builder;
...
public class Status404Reader {
  ...
  public Status404[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.killpostresponse.Status404 array, current token was %s", parser.currentToken()));
  }

package io.flexio.docker.api.inspectimagegetresponse.optional;
...
public class OptionalStatus200 {
  ...
  private OptionalImage payload = this.payload;
  ...
  public synchronized OptionalImage payload() {
    if(this.payload == null) {
      this.payload = OptionalImage.of(this.optional.isPresent() ? this.optional.get().payload() : null);
    }
    return this.payload;
  }

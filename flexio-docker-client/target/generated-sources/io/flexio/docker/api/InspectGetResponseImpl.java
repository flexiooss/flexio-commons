...
class InspectGetResponseImpl implements InspectGetResponse {
  ...
  InspectGetResponseImpl(Status200 status200, Status404 status404, Status500 status500) {
  ...
  public InspectGetResponse withStatus200(Status200 value) {
    return InspectGetResponse.from(this).status200(value).build();
  }

  public InspectGetResponse withStatus404(Status404 value) {
    return InspectGetResponse.from(this).status404(value).build();
  }

  public InspectGetResponse withStatus500(Status500 value) {
    return InspectGetResponse.from(this).status500(value).build();
  }
  ...
  public boolean equals(Object o) {
    ...
    InspectGetResponseImpl that = (InspectGetResponseImpl) o;

...
import io.flexio.docker.api.inspectgetresponse.Status500.Builder;
...
public class Status500Reader {
  ...
  public Status500[] readArray(JsonParser parser) throws IOException {
    ...
    throw new IOException(String.format("failed reading io.flexio.docker.api.inspectgetresponse.Status500 array, current token was %s", parser.currentToken()));
  }

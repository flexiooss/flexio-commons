...
public class OptionalStatus200 {
  ...
  private OptionalContainer payload = this.payload;
  ...
  public synchronized OptionalContainer payload() {
    if(this.payload == null) {
      this.payload = OptionalContainer.of(this.optional.isPresent() ? this.optional.get().payload() : null);
    }
    return this.payload;
  }

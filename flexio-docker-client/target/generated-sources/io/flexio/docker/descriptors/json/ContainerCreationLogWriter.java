...
public class ContainerCreationLogWriter {
  public void write(JsonGenerator generator, ContainerCreationLog value) throws IOException {
  ...
  public void writeArray(JsonGenerator generator, ContainerCreationLog[] values) throws IOException {
    if(values == null) {
      generator.writeNull();
    } else {
      generator.writeStartArray();
      for(ContainerCreationLog value : values) {

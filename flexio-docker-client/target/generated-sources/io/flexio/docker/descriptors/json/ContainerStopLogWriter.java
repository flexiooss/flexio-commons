...
public class ContainerStopLogWriter {
  public void write(JsonGenerator generator, ContainerStopLog value) throws IOException {
  ...
  public void writeArray(JsonGenerator generator, ContainerStopLog[] values) throws IOException {
    if(values == null) {
      generator.writeNull();
    } else {
      generator.writeStartArray();
      for(ContainerStopLog value : values) {

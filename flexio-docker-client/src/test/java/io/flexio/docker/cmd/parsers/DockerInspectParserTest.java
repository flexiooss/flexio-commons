...
public class DockerInspectParserTest {
    ...
    public void whenStoppedContainer__thenDataParsedFromJson_andNameHeadingSlashRemoved() throws Exception {
        assertThat(
                new DockerInspectParser(this.mapper).containerFor(resourceAsString("docker-cmds/docker-inspect-stopped-container.json")).get(),
    ...
    public void givenRunningContainer__whenNoLocalIP__thenDataParsedFromJson_andNameHeadingSlashRemoved_andIPIsEmpty() throws Exception {
        assertThat(
                new DockerInspectParser(this.mapper).containerFor(resourceAsString("docker-cmds/docker-inspect-running-container-without-toplevel-ip.json")).get(),
                is(Container.builder()
    ...
    public void givenRunningContainer__whenLocalIP__thenDataParsedFromJson_andNameHeadingSlashRemoved_andIPIsEmpty() throws Exception {
        assertThat(
                new DockerInspectParser(this.mapper).containerFor(resourceAsString("docker-cmds/docker-inspect-running-container-with-toplevel-ip.json")).get(),
                is(Container.builder()

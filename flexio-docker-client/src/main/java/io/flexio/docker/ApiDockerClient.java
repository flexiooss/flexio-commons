...
public class ApiDockerClient implements DockerClient {
    private final DockerEngineAPIClient client;
    private final String baseUrl;
    private final DockerAuth dockerAuth;

    public ApiDockerClient(HttpClientWrapper http, String baseUrl) {
        this(http, baseUrl, null);
    }
    public ApiDockerClient(HttpClientWrapper http, String baseUrl, String authToken) {
    ...
    private Container container(String containerName, ContainerCreationData containerCreationData) {
    ...
    static private final Logger log = LoggerFactory.getLogger(ApiDockerClient.class);

package io.flexio.commons.otsdb.api.storedatapointspostresponse.optional;
...
public class OptionalStatus400 {
  ...
  private OptionalStorageResponse payload = this.payload;
  ...
  public synchronized OptionalStorageResponse payload() {
    if(this.payload == null) {
      this.payload = OptionalStorageResponse.of(this.optional.isPresent() ? this.optional.get().payload() : null);
    }
    return this.payload;
  }
